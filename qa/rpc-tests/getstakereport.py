...
class GetStakeReport(StakeWorkTestFramework):
    ...
    def run_test(self):
        ...
        # Send funds to the spending address (leave me XSK for fees)
        ...
        # Make sure we have staked 2 XSK to the spending address
        ...
        # Send funds to the cold staking address (leave some XSK for fees)
        ...
        # Make sure we staked 4 XSK in spending address (2 XSK via COLD Stake)
        # So that means spending last 24h == 4
        # And staking last 24h == 2 We stake 2 XSK via COLD already
        # And merged will have the total of the spending + staking
