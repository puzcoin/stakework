...
class WalletTest (StakeWorkTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 XSK from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 XSK with subtract fee from amount
        ...
        # Sendmany 10 XSK with subtract fee from amount
