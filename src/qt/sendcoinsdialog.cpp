...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    // Check if we have selected a display unit that is not XSK
    if (model->getOptionsModel()->getDisplayUnit() != StakeWorkUnits::XSK)
        alternativeUnits.append(StakeWorkUnits::formatHtmlWithUnit(StakeWorkUnits::XSK, totalAmount));
