...
QString StakeWorkUnits::description(int unit)
{
    switch(unit)
    {
        case XSK: return QString("Stakework");
...
QString StakeWorkUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
